...
from configuration import TASK_APIS, DAILY_ANSWER_SUBMIT_CLASS_NAME, \
    ...
    DAILY_ANSWER_TIME_SLEEP, DAILY_ANSWER_API, WEEKLY_ANSWER_TOPIC_API, \
    WEEKLY_ANSWER_API, PROJECT_ANSWER_TOPIC_API, PROJECT_ANSWER_API
...
class Answer(object):
    ...
    __weekly_answer_topic_api: str = WEEKLY_ANSWER_TOPIC_API
    __weekly_answer_api: str = WEEKLY_ANSWER_API
    __project_answer_topic_api: str = PROJECT_ANSWER_TOPIC_API
    __project_answer_api: str = PROJECT_ANSWER_API
    ...
    def do_daily(self):
        ...
        self.__check_alert()
        self.__init_answer(url=DAILY_ANSWER_API)
    ...
    def do_weekly(self, num: int):
        self.__driver.get(url=self.__weekly_answer_topic_api.format(num=num))
        self.__check_alert()
        self.__init_answer(url=self.__weekly_answer_api.format(num=num))
    ...
    def do_project(self, num: int):
        self.__driver.get(url=self.__project_answer_topic_api.format(num=num))
        self.__check_alert()
        self.__init_answer(url=self.__project_answer_api.format(num=num))
