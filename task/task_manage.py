...
from tools.analysis import Analysis_Msg, Analysis_Task, \
    Analysis_Weekly_Answer, Analysis_Project_Answer
from config.task_config import TASK_ID, USER_KEYS, TASK_OPTIONS, \
    VIDEO_ACC_TIME, ARTICLE_ACC_TIME, DAILY_ANSWER_ACC_TIME, \
    WEEKLY_ANSWER_ACC_TIME, PROJECT_ANSWER_ACC_TIME
from config.can_change_config import ARTICLE_TIME, VIDEO_TIME
from task.answer import Answer
from task.daily_article import Daily_Article
from task.see_video import See_Video
...
class Task_Manage(object):
    ...
    def __create_score_window(self):
        ...
        if score_window is None or \
            ...
            task_window: str = self.__windows.get('')
